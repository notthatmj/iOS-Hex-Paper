...
class HexGridTests: XCTestCase {
    ...
    func test2by2HexGrid() {
        ...
        let v17 = Vertex(x: 3.0 * hexRadius, y: 3 * rowHeight)
    ...
    func test4by4HexGrid() {
        ...
        let v1 = Vertex(x: 0.5 * hexRadius, y:0)
        let v2 = Vertex(x: 1.5 * hexRadius, y:0)
        let v3 = Vertex(x: 3.5 * hexRadius, y:0)
        let v4 = Vertex(x: 4.5 * hexRadius, y:0)
        let v5 = Vertex(x: 0, y: rowHeight)
        let v6 = Vertex(x: 2 * hexRadius, y: rowHeight)
        let v7 = Vertex(x: 3 * hexRadius, y: rowHeight)
        let v8 = Vertex(x: 5 * hexRadius, y: rowHeight)
        let v9 = Vertex(x: 6 * hexRadius, y: rowHeight)
        let v10 = Vertex(x: 0.5 * hexRadius, y: 2 * rowHeight)
        let v11 = Vertex(x: 1.5 * hexRadius, y: 2 * rowHeight)
        let v12 = Vertex(x: 3.5 * hexRadius, y: 2 * rowHeight)
        let v13 = Vertex(x: 4.5 * hexRadius, y: 2 * rowHeight)
        let v14 = Vertex(x: 6.5 * hexRadius, y: 2 * rowHeight)
        let v15 = Vertex(x: 0, y: 3 * rowHeight)
        let v16 = Vertex(x: 2 * hexRadius, y: 3 * rowHeight)
        let v17 = Vertex(x: 3.0 * hexRadius, y: 3 * rowHeight)
        let v18 = Vertex(x: 5.0 * hexRadius, y: 3 * rowHeight)
        let v19 = Vertex(x: 6.0 * hexRadius, y: 3 * rowHeight)
        let v20 = Vertex(x: 0.5 * hexRadius, y: 4 * rowHeight)
        let v21 = Vertex(x: 1.5 * hexRadius, y: 4 * rowHeight)
        let v22 = Vertex(x: 3.5 * hexRadius, y: 4 * rowHeight)
        let v23 = Vertex(x: 4.5 * hexRadius, y: 4 * rowHeight)
        let v24 = Vertex(x: 6.5 * hexRadius, y: 4 * rowHeight)
        let v25 = Vertex(x: 0, y: 5 * rowHeight)
        let v26 = Vertex(x: 2.0 * hexRadius, y: 5 * rowHeight)
        let v27 = Vertex(x: 3.0 * hexRadius, y: 5 * rowHeight)
        let v28 = Vertex(x: 5.0 * hexRadius, y: 5 * rowHeight)
        let v29 = Vertex(x: 6.0 * hexRadius, y: 5 * rowHeight)
        let v30 = Vertex(x: 0.5 * hexRadius, y: 6 * rowHeight)
        let v31 = Vertex(x: 1.5 * hexRadius, y: 6 * rowHeight)
        let v32 = Vertex(x: 3.5 * hexRadius, y: 6 * rowHeight)
        let v33 = Vertex(x: 4.5 * hexRadius, y: 6 * rowHeight)
        let v34 = Vertex(x: 6.5 * hexRadius, y: 6 * rowHeight)
        let v35 = Vertex(x: 0, y: 7 * rowHeight)
        let v36 = Vertex(x: 2 * hexRadius, y: 7 * rowHeight)
        let v37 = Vertex(x: 3 * hexRadius, y: 7 * rowHeight)
        let v38 = Vertex(x: 5 * hexRadius, y: 7 * rowHeight)
        let v39 = Vertex(x: 6 * hexRadius, y: 7 * rowHeight)
        let v40 = Vertex(x: 0.5 * hexRadius, y: 8 * rowHeight)
        let v41 = Vertex(x: 1.5 * hexRadius, y: 8 * rowHeight)
        let v42 = Vertex(x: 3.5 * hexRadius, y: 8 * rowHeight)
        let v43 = Vertex(x: 4.5 * hexRadius, y: 8 * rowHeight)
        let v44 = Vertex(x: 6.5 * hexRadius, y: 8 * rowHeight)
        let v45 = Vertex(x: 2 * hexRadius, y: 9 * rowHeight)
        let v46 = Vertex(x: 3 * hexRadius, y: 9 * rowHeight)
        let v47 = Vertex(x: 5 * hexRadius, y: 9 * rowHeight)
        let v48 = Vertex(x: 6 * hexRadius, y: 9 * rowHeight)
